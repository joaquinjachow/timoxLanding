type CadenaCableAccesorioCategory = {
  name: string
  fullName?: string
  image: string
  categoryId: string
...
export const cadenasCablesAccesoriosCategories: readonly CadenaCableAccesorioCategory[] = [
  ...
  { name: "Tensores", fullName: "Tensores de ojo-gancho galvanizados", image: "/imagenes/Tensor.png", categoryId: "tensores_ojo_gancho" },
]